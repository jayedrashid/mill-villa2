...
const BarChart = ({data}) => {
    ...
    let valuesTotalMonthServiceFull = [];

    values.push(month1ServiceFull);
    values.push(month2ServiceFull);
    values.push(month3ServiceFull);
    values.push(month4ServiceFull);
    values.push(month5ServiceFull);
    values.push(month6ServiceFull);

    let sumTotalMonthServiceFull = 0;
    valuesTotalMonthServiceFull.forEach(n => sumTotalMonthServiceFull += n);
