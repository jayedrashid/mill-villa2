...
const TopCards = () => {
  ...
  return (
    <div className='grid lg:grid-cols-3 gap-4 p-4 pt-6'>
      ...
      <div className='col-span-1 bg-white flex justify-between w-full border p-4 rounded-lg'>
        ...
        <p className='bg-green-200 flex flex-col justify-center items-center p-2 rounded-lg'>
          ...
          <span className='text-sky-600 text-2xl uppercase'>{data[0].month}</span>
        </p>
      </div>
      ...
      <div className='col-span-1 bg-white flex justify-between w-full border p-4 rounded-lg'>
        ...
        <p className='bg-green-200 flex flex-col justify-center items-center p-2 rounded-lg'>
          <span className='text-green-700 text-lg whitespace-nowrap'>Total Expenses</span>
          <span className='text-sky-600 text-2xl uppercase'>{data[0].month}</span>
        </p>
      </div>
